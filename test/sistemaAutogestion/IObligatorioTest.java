 ...
 * // Retorno r = miSistema.crearAerolinea("Aerolineas Argentinas",
 * "Argentina",10);
 * // assertEquals(Retorno.ok().resultado, r.resultado);
 ...
 * // assertEquals(Retorno.ok().resultado, r.resultado);
 * // r = miSistema.crearVuelo("1111", "Ethiopian Airlines", "ET345", "Etiopía",
 * 1,
 * // 1, 2024, 24, 15);
 * // assertEquals(Retorno.ok().resultado, r.resultado);
 * //// }
 ...
 * // assertEquals(Retorno.ok().resultado, r.resultado);
 * // miSistema.crearVuelo("QF001", "Qantas", "QF123", "Australia", 2, 1, 2024,
 * 3, 3);
 * // assertEquals(Retorno.ok().resultado, r.resultado);
 * // r = miSistema.crearVuelo("QF001", "Qantas", "QF345", "Australia", 2, 1,
 * 2024, 3, 3);
 * // assertEquals(Retorno.error1().resultado, r.resultado);
 * // }
 * // @Test
 * // public void testCrearVueloErrorAerolíneaNoExistente() {
 * // Retorno r = miSistema.crearVuelo("EK123", "NoExistente", "EK001",
 * "Australia", 1, 1, 2023, 3, 3);}
 * //
 * 
 * /////////////////////////////////////////////////////////////////////////////
 * //////////////////////////////////////////////////////
 ...
 * // miSistema.crearVuelo("QF125", "Qantas", "QF001", "USA", 1, 1, 2025, 297,
 * 3);
 * // Retorno r = miSistema.crearVuelo("QF126", "Qantas", "QF001", "Canada", 1,
 * 1, 2025, 297, 3);
 ...
 * // assertEquals(Retorno.ok().resultado, r.resultado);
 * //
 * // r = miSistema.crearVuelo("QF1234", "Qantas", "QF001", "Sydney", 1, 1,
 * 2024, 66, 51);
 * // assertEquals(Retorno.ok().resultado, r.resultado);
 * // r = miSistema.crearVuelo("EK5678", "Emirates", "EK123", "Dubai", 2, 1,
 * 2024, 69, 99);
 * // assertEquals(Retorno.ok().resultado, r.resultado);
 * //
 ...
 * // assertEquals(Retorno.ok().resultado, r.resultado);
 * // assertEquals(
 * "QF1234-Qantas-QF001-Sydney-01/01/2024-66-51|\nEK5678-Emirates-EK123-Dubai-02/01/2024-69-99|",
 * r.valorString);
 * //
 * // }
 * 
 ...
 * 
 * // Crear vuelos
 * r = miSistema.crearVuelo("QF1234", "Qantas", "QF001", "Sydney", 1, 1, 2024,
 * 66, 51);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("EK5678", "Emirates", "EK123", "Dubai", 2, 1, 2024,
 * 69, 99);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * 
 * r = miSistema.registrarCliente("TUV6789", "Laura Ortiz", 35);
 ...
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * //Creación de vuelos
 * r = miSistema.crearVuelo("AA1111", "Aerolineas Argentinas", "FLY221",
 * "Uruguay", 10, 12, 2024, 12, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("AA2341", "Aerolineas Argentinas", "FLY300",
 * "Brasil", 1, 11, 2024, 6, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * }
 * 
 * @Test
 ...
 * "Uruguay", 10, 12, 2024, 12, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("AA2341", "Aerolineas Brasileras", "FLY300",
 * "Brasil", 1, 11, 2024, 6, 3);
 * assertEquals(Retorno.error2().resultado, r.resultado);
 * }
 * 
 ...
 * "Uruguay", 10, 12, 2024, 12, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("AA2341", "Aerolineas Argentinas", "FLY200",
 * "Brasil", 1, 11, 2024, 6, 3);
 * assertEquals(Retorno.error3().resultado, r.resultado);
 * }
 * 
 ...
 * "Uruguay", 10, 12, 2024, 12, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("AA2341", "Aerolineas Argentinas", "FLY221",
 * "Brasil", 10, 12, 2024, 6, 3);
 * assertEquals(Retorno.error4().resultado, r.resultado);
 * }
 * 
 * @Test
 ...
 * "Uruguay", 10, 12, 2024, 12, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("AA2222", "Aerolineas Argentinas", "FLY221",
 * "Uruguay", 2, 10, 2024, 6, 9);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("AA3333", "Aerolineas Argentinas", "FLY221",
 * "Uruguay", 5, 9, 2024, 3, 12);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * 
 * r = miSistema.listarVuelos();
 ...
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("AA2222", "Aerolineas Argentinas", "FLY221",
 * "Uruguay", 11, 12, 2024, 6, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("AA3333", "Aerolineas Argentinas", "FLY221",
 * "Uruguay", 14, 12, 2024, 6, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * 
 * //Compra de pasajes (hay disponible)
 * r = miSistema.comprarPasaje("MF34111", "AA1111", 1);
 ...
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * //Devolución de pasaje (se deberían otorgar a los dos clientes que están
 * esperando)
 * r = miSistema.devolverPasaje("MF34111", "AA2222");
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * 
 ...
 * "Uruguay", 10, 12, 2024, 6, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * r = miSistema.crearVuelo("AA9999", "Aerolineas Argentinas", "FLY221",
 * "Uruguay", 8, 12, 2024, 6, 3);
 * assertEquals(Retorno.ok().resultado, r.resultado);
 * //Compra de pasajes (hay disponible)
 * r = miSistema.comprarPasaje("MF34111", "AA1111", 1);
 * assertEquals(Retorno.ok().resultado, r.resultado);
